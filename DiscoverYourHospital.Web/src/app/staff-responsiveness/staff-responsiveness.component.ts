...
@Component({
  selector: 'app-staff-responsiveness',
  templateUrl: './staff-responsiveness.component.html'
})
export class StaffResponsivenessComponent implements OnInit {
  hcahpsData: Hcahps[] = [];
